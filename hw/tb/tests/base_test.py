...
class BaseTest:
    def __init__(self, dut, nodeslot_count,model_name = None,tolerance = 0.1, log_level= 'INFO', base_path=None, monitors = 0):#TODO change to inherint log level from logger not args
        self.dut = dut
