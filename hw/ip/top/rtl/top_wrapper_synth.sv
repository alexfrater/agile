...
// logic sys_clk;                                    // input wire sys_clk
// logic sys_clk_gt;                                 // input wire sys_clk_gt
// logic sys_rst_n;                                  // input wire sys_rst_n
// logic xdma_user_lnk_up;                           // output wire user_lnk_up
// logic [15:0] xdma_pci_exp_txp;                    // output wire [15 : 0] pci_exp_txp
// logic [15:0] xdma_pci_exp_txn;                    // output wire [15 : 0] pci_exp_txn
// logic [15:0] xdma_pci_exp_rxp;                    // input wire [15 : 0] pci_exp_rxp
// logic [15:0] xdma_pci_exp_rxn;                    // input wire [15 : 0] pci_exp_rxn
// logic xdma_axi_aclk;                              // output wire axi_aclk
// logic xdma_axi_aresetn;                           // output wire axi_aresetn
// logic [0:0] xdma_usr_irq_req;                     // input wire [0 : 0] usr_irq_req
// logic [0:0] xdma_usr_irq_ack;                     // output wire [0 : 0] usr_irq_ack
// logic xdma_msi_enable;                            // output wire msi_enable
// logic [2:0] xdma_msi_vector_width;                // output wire [2 : 0] msi_vector_width
...
//Connect AMPLE and XDMA  to DDR4 controller
...
`ifdef SYNTHESIS
    ...
    //Nodeslot memory
    // Instantiate DDR4 Memory Controller (ddr4_1) Nodeslot
    ddr4_1 u_ddr4_1 (
        .sys_rst                             (sys_rst),
