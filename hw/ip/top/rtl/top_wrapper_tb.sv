...
logic  [7:0]                   read_master_axi_awid;
...
//     for (genvar bank=0; bank < HBM_BANKS; bank++) begin: HBM_i
        axi_ram #(
            ...
            .s_axi_awready          (read_master_axi_awready           ),
            ...
            .s_axi_wready           (read_master_axi_wready            ),
            .s_axi_bid              (read_master_axi_bid               ),
            .s_axi_bresp            (read_master_axi_bresp             ),
            .s_axi_bvalid           (read_master_axi_bvalid            ),
            .s_axi_bready           (transformation_engine_axi_bready  ),


            .s_axi_arid             (read_master_axi_arid    ),
            .s_axi_araddr           (read_master_axi_araddr  ),
            .s_axi_arlen            (read_master_axi_arlen   ),
            .s_axi_arsize           (read_master_axi_arsize  ),
            .s_axi_arburst          (read_master_axi_arburst ),
            .s_axi_arlock           (read_master_axi_arlock  ),
            .s_axi_arcache          (read_master_axi_arcache ),
            .s_axi_arprot           (read_master_axi_arprot  ),
            .s_axi_arvalid          (read_master_axi_arvalid ),
            .s_axi_arready          (read_master_axi_arready ),
            .s_axi_rid              (read_master_axi_rid     ),
            .s_axi_rdata            (read_master_axi_rdata   ),
            .s_axi_rresp            (read_master_axi_rresp   ),
            .s_axi_rlast            (read_master_axi_rlast   ),
            .s_axi_rvalid           (read_master_axi_rvalid  ),
            .s_axi_rready           (read_master_axi_rready  )
        );
    // end
// end
// endgenerate
